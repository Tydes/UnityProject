...
namespace AmplifyShaderEditor
{
	...
	public class CreateConnectionActionData : ActionData
	{
		...
		public override void ExecuteReverse()
		{
			UIUtils.DeleteConnection(true,m_inputNodeId,m_inputPortId ,false);
		}
	...
	public class MoveInputConnectionActionData : ActionData
	{
		...
		public override void ExecuteForward()
		{
			UIUtils.DeleteConnection(true, m_oldInputNodeId, m_oldInputNodePortId,false);
		...
		{
			base.ExecuteReverse();
			UIUtils.DeleteConnection(true, m_newInputNodeId, m_newInputNodePortId,false);
	...
	public class MoveOutputConnectionActionData : ActionData
	{
		...
		public override void ExecuteForward()
		{
			UIUtils.DeleteConnection(false, m_oldOutputNodeId, m_oldOutputNodeId,false);
		...
		{
			base.ExecuteReverse();
			UIUtils.DeleteConnection(false, m_newOutputNodeId, m_newOutputPortId,false);
