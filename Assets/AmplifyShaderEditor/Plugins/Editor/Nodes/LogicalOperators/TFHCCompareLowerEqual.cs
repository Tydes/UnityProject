...
{
    [Serializable]
	[NodeAttributes("Compare (A <= B)", "Logical Operators", "Check if A is lower than or equal to B. If true return value of True else return value of False", null, KeyCode.None)]
    public sealed class TFHCCompareLowerEqual : DynamicTypeNode
    {
