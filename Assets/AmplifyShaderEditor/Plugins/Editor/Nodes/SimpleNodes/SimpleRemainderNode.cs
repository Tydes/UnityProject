...
namespace AmplifyShaderEditor
{
	...
	public sealed class SimpleRemainderNode : ParentNode
	{
		...
		{
			m_inputA = m_inputPorts[ 0 ].GenerateShaderForOutput( ref dataCollector, WirePortDataType.INT, ignoreLocalvar, 0, true );
			m_inputB = m_inputPorts[ 1 ].GenerateShaderForOutput( ref dataCollector, WirePortDataType.INT, ignoreLocalvar, 0, true );
